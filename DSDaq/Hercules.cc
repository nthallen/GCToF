...
dio_scdc_def Hercules::scdc_def[] = {
  ...
  { HERC_STRB,   1,  0x4,  0x4 }, // 16  Turbo scroll pump off
  { HERC_STRB,   1,  0x2,  0x2 }, // 17  Turbo scroll pump on
  { HERC_STRB,   1, 0x10, 0x10 }, // 18  Turbo scroll pump valve off
  { HERC_STRB,   1,  0x8,  0x8 }, // 19  Turbo scroll pump valve on
  { HERC_STRB,   1, 0x40, 0x40 }, // 20  Flow tube scroll pump off
  { HERC_STRB,   1, 0x20, 0x20 }, // 21  Flow tube scroll pump on
  { HERC_STRB,   2,  0x1,  0x1 }, // 22  Flow tube scroll pump valve off
  { HERC_STRB,   1, 0x80, 0x80 }, // 23  Flow tube scroll pump valve on
  { HERC_STRB,   2,  0x4,  0x4 }, // 24  Flow tube dewar valve off
  { HERC_STRB,   2,  0x2,  0x2 }, // 25  Flow tube dewar valve on
