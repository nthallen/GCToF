...
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'add', 0, 1, 'gGCToF', 'gpsd' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFmode', 'mode' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFtime', 'time' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFlat', 'lat' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFlon', 'lon' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFalt', 'alt' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFtrack', 'track' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFspeed', 'speed' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFclimb', 'climb' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFsats', 'sats' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFstale', 'stale' );
f = ne_dialg(f, 'add', 0, 1, 'gGCToFgpsd_err', 'gpsd err' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgpsd_errtime', 'time' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgpsd_errdist', 'dist' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgpsd_errtrack', 'track' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgpsd_errspeed', 'speed' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgpsd_errclimb', 'climb' );
f = ne_dialg(f, 'add', 0, 1, 'gGCToFgpsd_toff', 'gpsd toff' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgpsd_toffsec', 'sec' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgpsd_toffnsec', 'nsec' );
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'add', 0, 1, 'gGCToFgpsd_status', 'gpsd status' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgpsd_statusdata', 'data' );
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgpsd_statuserror', 'error' );
...
f = ne_dialg(f, 'add', 1, 0, 'pGCToFgcwgcpmt', 'GCPM6 T' );
